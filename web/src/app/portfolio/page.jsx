        ...
        <section className="py-20 md:py-32 px-6 bg-gradient-to-b from-[#FEFEFE] to-[#F8F8F8] dark:from-[#0B0B10] dark:to-[#111111]">
          <div className="max-w-[1000px] mx-auto text-center">
            <h1 className="text-4xl md:text-[56px] leading-tight md:leading-[1.1] text-black dark:text-white mb-6 font-bold">
              Selected <span className="text-[#6C5CE7]">Work</span>
            </h1>
          ...
          <div className="max-w-[1200px] mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {projects.map((project, index) => (
                <div
                  key={index}
                  className="group bg-[#F8F9FA] dark:bg-[#1A1A1A] rounded-3xl overflow-hidden border border-[#E5E5E5] dark:border-[#333333] hover:border-[#6C5CE7]/30 dark:hover:border-[#6C5CE7]/30 transition-all duration-300 hover:transform hover:scale-105"
                >
                  {/* Project Image */}
                  <div className="aspect-video overflow-hidden bg-gradient-to-br from-[#6C5CE7] to-[#00D1FF] relative">
                    <img
                      src={project.image}
                      alt={project.name}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.tags.map((tag, tagIndex) => (
                        <span
                          key={tagIndex}
                          className="px-3 py-1 bg-[#6C5CE7]/10 text-[#6C5CE7] text-xs font-medium rounded-full"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <div className="flex items-center gap-2 text-[#6C5CE7] font-medium text-sm group-hover:gap-3 transition-all duration-200">
